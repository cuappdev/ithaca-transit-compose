...
fun getAboutContent(key: String): String {
    val aboutContent = buildMap {
        put("Terrace Restaurant", "The Terrace often features five to six made-to-order options, such as burritos, pho, gyros, and more throughout the day.")
        put("Mac's Café", "Mac's features grab-and-go deli sandwiches, pizza, chopped salads and healthy smoothies for those looking for a quick bite.")
        put("Temple of Zeus", "Serving up fresh soups, salads, and sandwiches for students and faculty.")
        put("Gimme Coffee", "Cappuccinos, hot coffee, and pastries are available here Monday-Friday from 8am-3pm!")
        put("Louie's Lunch", "Louie's Lunch is a food truck featuring an extensive menu with subs, wraps, salads, milkshakes, cajun fries, and much more.")
        put("Anabel's Grocery", "Anabel's Grocery is a student-run nonprofit grocery store that provides fresh, nutritious, and affordable food to Cornell students.")
        put("Free Food Fridge", "The Free Food Fridge stocks excess food from campus cafes and leftover food from campus events to prevent it from being wasted.")
